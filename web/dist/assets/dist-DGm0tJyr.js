import { HighlightStyle, h as EditorView, r as tags, syntaxHighlighting } from "./dist-CFtxRP70.js";
//#region node_modules/@catppuccin/palette/esm/palette.js
var palette_default = {
	"version": "1.8.0",
	"latte": {
		"name": "Latte",
...
//#endregion
//#region node_modules/@catppuccin/palette/esm/mod.js
var entriesFromObject = (obj) => Object.entries(obj);
var { version: _, ...jsonFlavors } = palette_default;
palette_default.version;
/**
* All flavors of Catppuccin.
*/
var flavors = entriesFromObject(jsonFlavors).reduce((acc, [flavorName, flavor]) => {
	acc[flavorName] = {
		...flavor,
...
//#endregion
//#region node_modules/@catppuccin/codemirror/dist/index.js
function createCatppuccinTheme(flavor) {
	...
	const theme = EditorView.theme({
		...
		".cm-content": { caretColor: colors.rosewater.hex },
		".cm-cursor, .cm-dropCursor": { borderLeftColor: colors.rosewater.hex },
		"&.cm-focused > .cm-scroller > .cm-selectionLayer .cm-selectionBackground, .cm-selectionBackground, .cm-content ::selection": { backgroundColor: `${colors.overlay2.hex}40` },
		".cm-panels": {
		...
		".cm-searchMatch.cm-searchMatch-selected": { backgroundColor: `${colors.blue.hex}2f` },
		".cm-activeLine": { backgroundColor: colors.surface0.hex },
		".cm-selectionMatch": { backgroundColor: `${colors.surface2.hex}4d` },
		...
		".cm-activeLineGutter": { backgroundColor: colors.surface0.hex },
		".cm-foldPlaceholder": {
			backgroundColor: "transparent",
			border: "none",
			color: colors.overlay0.hex
		},
		".cm-placeholder": { color: colors.overlay1.hex },
		".cm-tooltip": {
			border: "none",
...
var catppuccinLatte = /*@__PURE__*/ createCatppuccinTheme(flavors.latte);
var catppuccinFrappe = /*@__PURE__*/ createCatppuccinTheme(flavors.frappe);
var catppuccinMacchiato = /*@__PURE__*/ createCatppuccinTheme(flavors.macchiato);
var catppuccinMocha = /*@__PURE__*/ createCatppuccinTheme(flavors.mocha);
//#endregion
